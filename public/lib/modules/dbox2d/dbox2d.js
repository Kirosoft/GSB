...
/*
based on Box2dWeb-2.1.a.3.min.js from:
http://code.google.com/p/box2dweb/downloads/detail?name=Box2dWeb-2.1a.3.zip&can=2&q=

*/

//ig.module('plugins.box2d.box2dweb').defines(function(){
...
(function () {
  ...
  b2Body.b2Body = function () {
	...
	// MPN: 17/11/12 Fix for IE9 
	if( Object.defineProperty ) { // Standard

		Object.defineProperty(m_lv,"x",{
			get: function() {
					return this._x;
				},
			set: function(val) {
		...
		m_lv.__defineGetter__("x", function(){
			return m_lv._x;
		});    
		m_lv.__defineSetter__("x", function(xx){
			if(m_lv.count<1000) {
				m_lv.count++;
				//console.log('x:'+xx);
			}
		...
		m_lv.__defineGetter__("y", function(){
			return m_lv._y;
		});    
		m_lv.__defineSetter__("y", function(yy){
			if(m_lv.count<1000) {
				m_lv.count++;
				//console.log('y:'+yy);
			}
...
//}
  b2Body.prototype.SetTransform = function (pos, angle) {
	this.SetPositionAndAngle(pos, angle);
  }
...
//GetRoundedAngle
b2.Body.prototype.GetRoundedAngle = function(){
	return this.GetAngle().round(2);
};
//ApplyLinearImpulse
b2.Body.prototype.ApplyLinearImpulse = b2.Body.prototype.ApplyImpulse;
