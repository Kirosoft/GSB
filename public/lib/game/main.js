...
require('./levels/test');
require('../modules/dbox2d/game.js');
require('../game/entities/player');
require('../game/entities/crate');
require('../game/entities/spider');
require('../game/entities/SpiderHub');
require('../game/entities/ForceField');
require('../game/entities/Turret');
require('../game/entities/Ram');

MyGame = class MyGameStart extends ig.Box2DGame {

    constructor() {
        super();
        this.gravity= 100; // All entities are affected by this

        this.clearColor = '#1b2026';
        this.paused = false;
        this.removeList =  [];
        this.TYPE_WALL = 0;
        this.TYPE_PLAYER = 1;
        ...
        */
        ...
        myListener.BeginContact = function (contact) {
            ...
            var result = contactTable[type1][type2];
