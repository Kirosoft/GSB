/**
 * Created by marknorman on 28/07/15.
 */
...
function createSpacePlane(){
    ...
    var updatePlaneMaterial = function(){
        if( true /*camera.position.z < 1500*/ ){
            this.material.opacity = 0.3; //constrain( (camera.position.z - 400.0) * 0.002, 0, 0.5);
            if( this.material.map !== undefined && this.material.opacity <= 0.1 ){
